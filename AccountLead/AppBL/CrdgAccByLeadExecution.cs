                ...
                if (AccountDDE.Count > 0)
                {
                    if (string.IsNullOrEmpty(AccountDDE[0]["eqs_accountnocreated"].ToString()))
                    {
                        ...
                        else
                        {
                            ...
                            msgBdy.productCode = AccountDDE[0]["eqs_productid"]["eqs_productcode"].ToString();
                            ...
                            msgBdy.tdaccountPayinRequest.payinNarration = $"Equitas TD/{AccountDDE[0]["eqs_leadaccountid"]["eqs_crmleadaccountid"].ToString()}/{accountTitle}";
